-- Add permitted_until to student_dues to allow temporary clearance
ALTER TABLE student_dues ADD COLUMN IF NOT EXISTS permitted_until TIMESTAMPTZ;

-- Update the trigger to allow clearance if they have a valid permit
